...
async def telnyx_webhook(request: Request):
    ...
    try:
        ...
        if event_type == "call.answered":
            ...
            # Non-blocking async HTTP client for Telnyx streaming start request
...
async def media_stream_endpoint(websocket: WebSocket):
    ...
    Uses an audio queue to accept the WebSocket instantly to prevent carrier timeouts.
    """
    ...
    # Start reading from Telnyx immediately in a background task
    ...
    try:
        ...
        async with websockets.connect(gemini_url) as gemini_ws:
            ...
            # Wait for setupComplete confirmation
            ...
            # Task to drain queue and send audio to Gemini
            ...
            # Task to read audio from Gemini and send back to Telnyx
            ...
            # Wait until one of the connection legs ends
